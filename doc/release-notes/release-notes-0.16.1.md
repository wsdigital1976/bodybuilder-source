Bodybuilder Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/bodybuilder-core-0.16.1/>
...
- #12843 `df38b13` Test starting bodybuilderd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bodybuilderd processes are cleaned up when tests end (sdaftuar)
