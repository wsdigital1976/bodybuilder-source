Bodybuilder Core version *0.15.0.1* is now available from:

  <https://bodybuilder.org/bin/bodybuilder-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/bodybuilder-core-0.15.0.1/>
