Bodybuilder Core version 0.9.4 is now available from:

  https://bodybuilder.org/bin/0.9.4/
...
this update is incompatible with the Bodybuilder system and could lead to consensus
forks.

Bodybuilder Core released binaries from https://bodybuilder.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bodybuilder/+archive/ubuntu/bodybuilder
- A third-party or self-compiled Bodybuilder Core

upgrade to Bodybuilder Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
