Bodybuilder Core version 0.10.4 is now available from:

  <https://bodybuilder.org/bin/bodybuilder-core-0.10.4/>
...
- #6953 `43c2789` Split bodybuilder-tx into its own package
- #6953 `dfe0d4d` Include bodybuilder-tx binary on Debian/Ubuntu
