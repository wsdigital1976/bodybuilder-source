Bodybuilder Core version 0.9.2.1 is now available from:

  https://bodybuilder.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BYLL to 0.01 BYLL
...
- Fix "Start bodybuilder on system login"
