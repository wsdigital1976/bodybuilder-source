Bodybuilder-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bodybuilder/files/Bodybuilder/bodybuilder-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bodybuilder
...
New/changed settings (command-line or bodybuilder.conf file)
--------------------------------------------------------
