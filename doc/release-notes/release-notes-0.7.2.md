Bodybuilder version 0.7.2 is now available from:
  http://sourceforge.net/projects/bodybuilder/files/Bodybuilder/bodybuilder-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Bodybuilder-Qt to crash on Windows when exiting.
