Download URL: https://sourceforge.net/projects/bodybuilder/files/Bodybuilder/bodybuilder-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BYLL fee schedule (users still pay 0.01 BYLL per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bodybuilder00 - #bodybuilder99
