Bodybuilder Core version 0.13.2 is now available from:

  <https://bodybuilder.org/bin/bodybuilder-core-0.13.2/>
...
- #8908 `4a974b2` Update bodybuilder-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bodybuilder-tx to create v2 transactions (bylldrak)
