Bodybuilder version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bodybuilder/files/Bodybuilder/bodybuilder-0.5.4/
...
http://gitorious.org/bodybuilder/bodybuilderd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bodybuilder-Qt notifications under Growl 1.3.
Increase required age of Bodybuilder-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBodybuilder properly when installing Bodybuilder-Qt over it. (Windows)
