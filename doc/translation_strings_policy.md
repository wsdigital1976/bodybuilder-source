...
This document provides guidelines for internationalization of the Bodybuilder Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bodybuilder_en.ts` remains unchanged.
