...
#ifndef BODYBUILDER_INTERFACES_INIT_H
#define BODYBUILDER_INTERFACES_INIT_H
...
//! (bodybuilder-gui, bodybuilder-node, bodybuilder-wallet, bodybuilderd, bodybuilder-qt) and each
...
#endif // BODYBUILDER_INTERFACES_INIT_H
