...
#ifndef BODYBUILDER_INTERFACES_NODE_H
#define BODYBUILDER_INTERFACES_NODE_H
...
//! Top-level interface for a bodybuilder node (bodybuilderd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bodybuilder.conf.
...
#endif // BODYBUILDER_INTERFACES_NODE_H
