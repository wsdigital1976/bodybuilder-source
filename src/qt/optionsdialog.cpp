      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bodybuilderAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bodybuilderAtStartup);
    ...
    ui->bodybuilderAtStartup->setToolTip(ui->bodybuilderAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bodybuilderAtStartup->setText(ui->bodybuilderAtStartup->text().arg(PACKAGE_NAME));

    ui->openBodybuilderConfButton->setToolTip(ui->openBodybuilderConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BodybuilderUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bodybuilderAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBYLLontrols);
...
void OptionsDialog::on_openBodybuilderConfButton_clicked()
{
    ...
    if (!GUIUtil::openBodybuilderConf())
