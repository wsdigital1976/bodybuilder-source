...
//! Entry point for BodybuilderApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BodybuilderApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BodybuilderGUI tests.
void AppTests::guiTests(BodybuilderGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BodybuilderGUI::consoleShown, this, &AppTests::consoleTests);
