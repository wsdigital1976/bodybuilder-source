...
#ifndef BODYBUILDER_QT_WALLETMODEL_H
#define BODYBUILDER_QT_WALLETMODEL_H
...
/** Interface to Bodybuilder wallet from Qt view code. */
...
#endif // BODYBUILDER_QT_WALLETMODEL_H
