...
#ifndef BODYBUILDER_QT_BODYBUILDERUNITS_H
#define BODYBUILDER_QT_BODYBUILDERUNITS_H
...
/** Bodybuilder unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BodybuilderUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BodybuilderUnits(QObject *parent);

    /** Bodybuilder units.
      @note Source: https://en.bodybuilder.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BYLL,
        mBYLL,
