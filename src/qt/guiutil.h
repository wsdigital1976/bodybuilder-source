...
#ifndef BODYBUILDER_QT_GUIUTIL_H
#define BODYBUILDER_QT_GUIUTIL_H
...
/** Utility functions used by the Bodybuilder Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bodybuilder:" URI into recipient object, return true on successful parsing
...
#endif // BODYBUILDER_QT_GUIUTIL_H
