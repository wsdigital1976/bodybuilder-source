...
#ifndef BODYBUILDER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BODYBUILDER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BODYBUILDER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
