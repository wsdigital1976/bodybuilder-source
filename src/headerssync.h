...
#ifndef BODYBUILDER_HEADERSSYNC_H
#define BODYBUILDER_HEADERSSYNC_H
 ...
 *
 * The Bodybuilder protocol does not offer an easy way to determine the work on a
...
#endif // BODYBUILDER_HEADERSSYNC_H
