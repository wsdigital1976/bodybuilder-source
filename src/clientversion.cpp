 ...
 * for both bodybuilderd and bodybuilder-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bodybuilder/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bodybuilder/bodybuilder>";
