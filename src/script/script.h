...
#ifndef BODYBUILDER_SCRIPT_SCRIPT_H
#define BODYBUILDER_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Bodybuilder always counted CHECKMULTISIGs
...
#endif // BODYBUILDER_SCRIPT_SCRIPT_H
