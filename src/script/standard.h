...
#ifndef BODYBUILDER_SCRIPT_STANDARD_H
#define BODYBUILDER_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bodybuilder address
 */
...
/**
 * Generate a Bodybuilder scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BODYBUILDER_SCRIPT_STANDARD_H
