...
#ifndef BODYBUILDER_SCRIPT_MINISCRIPT_H
#define BODYBUILDER_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bodybuilder script
...
#endif // BODYBUILDER_SCRIPT_MINISCRIPT_H
