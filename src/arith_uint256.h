...
#ifndef BODYBUILDER_ARITH_UINT256_H
#define BODYBUILDER_ARITH_UINT256_H
...
public:
     ...
     *
     * Bodybuilder only uses this "compact" format for encoding difficulty
...
#endif // BODYBUILDER_ARITH_UINT256_H
