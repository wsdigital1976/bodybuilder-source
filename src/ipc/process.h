...
#ifndef BODYBUILDER_IPC_PROCESS_H
#define BODYBUILDER_IPC_PROCESS_H
...
//! IPC process interface for spawning bodybuilder processes and serving requests
...
#endif // BODYBUILDER_IPC_PROCESS_H
