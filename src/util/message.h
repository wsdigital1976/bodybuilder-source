...
#ifndef BODYBUILDER_UTIL_MESSAGE_H
#define BODYBUILDER_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bodybuilder address, it must refer to a public key.
...
#endif // BODYBUILDER_UTIL_MESSAGE_H
