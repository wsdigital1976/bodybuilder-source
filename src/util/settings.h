...
#ifndef BODYBUILDER_UTIL_SETTINGS_H
#define BODYBUILDER_UTIL_SETTINGS_H
...
//!       https://github.com/bodybuilder/bodybuilder/pull/15934/files#r337691812)
...
#endif // BODYBUILDER_UTIL_SETTINGS_H
