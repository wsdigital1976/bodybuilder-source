...
#ifndef BODYBUILDER_UTIL_SYSCALL_SANDBOX_H
#define BODYBUILDER_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bodybuilderd initialization if Bodybuilder Core was compiled
...
#endif // BODYBUILDER_UTIL_SYSCALL_SANDBOX_H
