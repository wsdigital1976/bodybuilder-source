...
#ifndef BODYBUILDER_CRYPTO_CHACHA_POLY_AEAD_H
#define BODYBUILDER_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bodybuilder.
 *
 ...
 *
 * The chacha20-poly1305@bodybuilder combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bodybuilder cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bodybuilder are relatively fast in
...
#endif // BODYBUILDER_CRYPTO_CHACHA_POLY_AEAD_H
