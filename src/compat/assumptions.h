...
#ifndef BODYBUILDER_COMPAT_ASSUMPTIONS_H
#define BODYBUILDER_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Bodybuilder cannot be compiled without assertions."
#endif
...
#endif // BODYBUILDER_COMPAT_ASSUMPTIONS_H
