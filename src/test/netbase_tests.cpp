...
{
    BOOST_CHECK(TestSplitHost("www.bodybuildercore.org", "www.bodybuildercore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bodybuildercore.org]", "www.bodybuildercore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bodybuildercore.org:80", "www.bodybuildercore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bodybuildercore.org]:80", "www.bodybuildercore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:13690", "127.0.0.1", 13690));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:13690", "127.0.0.1", 13690));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:13690", "::ffff:127.0.0.1", 13690));
    BOOST_CHECK(TestSplitHost("[::]:13690", "::", 13690));
    BOOST_CHECK(TestSplitHost("::13690", "::13690", 0));
    BOOST_CHECK(TestSplitHost(":13690", "", 13690));
    BOOST_CHECK(TestSplitHost("[]:13690", "", 13690));
    ...
    BOOST_CHECK(TestSplitHost("www.bodybuildercore.org:65536", "www.bodybuildercore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bodybuildercore.org:0", "www.bodybuildercore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bodybuildercore.org:", "www.bodybuildercore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:13690", "127.0.0.1:13690"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:13690", "[::]:13690"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
