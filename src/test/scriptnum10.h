...
#ifndef BODYBUILDER_TEST_SCRIPTNUM10_H
#define BODYBUILDER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bodybuilder Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BODYBUILDER_TEST_SCRIPTNUM10_H
