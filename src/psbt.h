...
#ifndef BODYBUILDER_PSBT_H
#define BODYBUILDER_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Bodybuilder transaction.) Returns true if the merge succeeded, false otherwise. */
