...
#ifndef BODYBUILDER_RPC_PROTOCOL_H
#define BODYBUILDER_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bodybuilderd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bodybuilder is not connected
...
#endif // BODYBUILDER_RPC_PROTOCOL_H
