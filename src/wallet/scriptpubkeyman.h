...
#ifndef BODYBUILDER_WALLET_SCRIPTPUBKEYMAN_H
#define BODYBUILDER_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bodybuilder Core wallet was originally a collection of unrelated private
...
#endif // BODYBUILDER_WALLET_SCRIPTPUBKEYMAN_H
