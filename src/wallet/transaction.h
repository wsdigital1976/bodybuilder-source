...
#ifndef BODYBUILDER_WALLET_TRANSACTION_H
#define BODYBUILDER_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bodybuilder node, and set to 0 for transactions that were created
...
#endif // BODYBUILDER_WALLET_TRANSACTION_H
