...
#ifndef BODYBUILDER_WALLET_WALLETUTIL_H
#define BODYBUILDER_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bodybuilder from opening the wallet, thinking it was newly created, and
...
#endif // BODYBUILDER_WALLET_WALLETUTIL_H
