...
class NetTest(BodybuilderTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=13690)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 13690)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=13690), {"success": False})
