...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bodybuilder/bodybuilder/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bodybuilderd node")
