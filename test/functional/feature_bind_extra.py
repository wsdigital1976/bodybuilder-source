...
"""
Test starting bodybuilderd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bodybuilderd has bound on "::1" (for RPC) and "::" (for P2P).
