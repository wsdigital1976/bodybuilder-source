...
class TxnMallTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BYLL:
        ...
        # First: use raw transaction API to send 1240 BYLL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BYLL coin each
        ...
        # Node0's balance should be starting balance, plus 50BYLL for another
        ...
        # Node0's total balance should be starting balance, plus 100BYLL for
