...
class TestShell:
    """Wrapper Class for BodybuilderTestFramework.

    The TestShell class extends the BodybuilderTestFramework
    ...
    class __TestShell(BodybuilderTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BodybuilderTestFramework child class.
            self.num_nodes = 1
