...
By default, bodybuilderd will dump mempool on shutdown and
...
class MempoolPersistTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bodybuilderd from writing mempool.dat to disk. Verify that `savemempool` fails")
