...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BodybuilderTestFramework
    pass


class ExampleTest(BodybuilderTestFramework):
    # Each functional test is a subclass of the BodybuilderTestFramework class.
    ...
    def custom_method(self):
        ...
        BodybuilderTestFramework class so other tests can use it."""
