...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bodybuilder/bodybuilder/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bodybuilder/bodybuilder/blob/master/doc/tracing.md#tracepoint-validationblock_connected
