...
"""Verify that starting bodybuilder with -h works as expected."""

from test_framework.test_framework import BodybuilderTestFramework
from test_framework.util import assert_equal

class HelpTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bodybuilder with -h for help text")
        ...
        self.log.info("Start bodybuilder with -version for version information")
        ...
        self.log.info("Start bodybuilderd with -fakearg to make sure it does not start")
