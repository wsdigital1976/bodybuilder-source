...
Verify that a bodybuilderd node can use an external signer command.
...
class RPCSignerTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bodybuilderd with -signer=<cmd>',
