...
class TransactionTimeRescanTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BYLL and create transactions
        ...
        # generate some byll to create transactions and check blockcount
        ...
        # send 10 byll to user's first watch-only address
        self.log.info('Send 10 byll to user')
        ...
        # send 5 byll to our second watch-only address
        self.log.info('Send 5 byll to user')
        ...
        # send 1 byll to our third watch-only address
        self.log.info('Send 1 byll to user')
