...
# TestP2PConn: A peer we use to send messages to bodybuilderd, and store responses.
...
class CompactBlocksTest(BodybuilderTestFramework):
    ...
    # This test actually causes bodybuilderd to (reasonably!) disconnect us, so do this last.
    ...
    # bodybuilderd's choice of nonce.
    ...
    # Test that bodybuilderd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bodybuilderd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bodybuilderd will not send blocktxn responses for blocks whose height is
