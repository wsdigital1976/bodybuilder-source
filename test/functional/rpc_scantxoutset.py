...
class ScantxoutsetTest(BodybuilderTestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 BYLL, so each amounts uniquely identifies a subset.
