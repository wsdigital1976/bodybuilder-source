...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Bodybuilder Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a bodybuilder source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Bodybuilder Core developers'
...
Arguments:
    <file> - A source file in the bodybuilder repository.
"""
