...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BODYBUILDER_CHAINPARAMSSEEDS_H\n')
    g.write('#define BODYBUILDER_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bodybuilder network\n')
    ...
    g.write('#endif // BODYBUILDER_CHAINPARAMSSEEDS_H\n')
