...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of bodybuilder node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple bodybuilder ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple bodybuilder ports', file=sys.stderr)
