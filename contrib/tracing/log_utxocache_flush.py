...
"""Example logging Bodybuilder Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bodybuilderd
...
def main(bodybuilderd_path):
    ...
    b = BPF(text=program, usdt_contexts=[bodybuilderd_with_usdts])
