...
""" Interactive bodybuilderd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Bodybuilder Core can enable. It uses BCC
...
def main(bodybuilderd_path):
    ...
    bodybuilderd_with_usdts.enable_probe(
