...
# Extract options
function __fish_bodybuilder_tx_get_options
...
# Extract commands
function __fish_bodybuilder_tx_get_commands
...
# Add options
complete \
    --command bodybuilder-tx \
    --condition "not __fish_bodybuilder_seen_cmd (__fish_bodybuilder_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bodybuilder_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bodybuilder-tx \
    --arguments "(__fish_bodybuilder_tx_get_commands)" \
    --no-files
