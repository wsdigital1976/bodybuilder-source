...
complete --command bodybuilderd --no-files

# Extract options
function __fish_bodybuilderd_get_options
...
complete \
    --command bodybuilderd \
    --arguments "(__fish_bodybuilderd_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command bodybuilderd \
...
complete \
    --command bodybuilderd \
    --arguments "(__fish_bodybuilderd_get_options --nofiles)"
