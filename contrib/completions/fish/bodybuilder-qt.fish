...
complete --command bodybuilder-qt --no-files

# Extract options
function __fish_bodybuilderqt_get_options
...
complete \
    --command bodybuilder-qt \
    --arguments "(__fish_bodybuilderqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bodybuilder-qt \
...
complete \
    --command bodybuilder-qt \
    --arguments "(__fish_bodybuilderqt_get_options --nofiles)"
