...
libs = [
    'libbodybuilder_cli',
    'libbodybuilder_common',
    'libbodybuilder_crypto',
    'libbodybuilder_node',
    'libbodybuilder_util',
    'libbodybuilder_wallet_tool',
    'libbodybuilder_wallet',
    'libbodybuilder_zmq',
    'bench_bodybuilder',
    'libtest_util',
]
...
def parse_config_into_byll_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Bodybuilder Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/bodybuilder_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/bodybuilder_config.h'), "w", encoding="utf8") as byll_config:
        byll_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='Bodybuilder-core msbuild configuration initialiser.')
    ...
    parse_config_into_byll_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bodybuilder_config.h'), os.path.join(SOURCE_DIR, 'config/bodybuilder-config.h'))
